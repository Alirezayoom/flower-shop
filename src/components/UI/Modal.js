...
const ModalOverlay = props => {
    return <div className="md:w-[60%] w-[90%]  max-h-[70%] overflow-auto md:left-[20%] left-[5%] h-auto fixed bg-white mx-auto rounded-xl top-[15vh] items-center z-50">{props.children}</div>
}
